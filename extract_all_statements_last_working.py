...
class CombinedStatementParser:
    ...
    def save_to_excel(self):
        ...
        with pd.ExcelWriter(self.output_excel, engine='xlsxwriter') as writer:
            ...
            # Title
            worksheet.merge_range('A1:F1', 'Bank Statement Summary - October 2025', title_fmt)
            ...
            # Total row
            last_row = len(df) + 3
            worksheet.write(last_row, 2, 'GRAND TOTAL:', total_label_fmt)
...
def select_output_file():
    ...
    default_name = f"Bank_Statement_Summary_{datetime.now().strftime('%b_%Y')}.xlsx"
...
def main():
    ...
    try:
        ...
        messagebox.showinfo(
            "Processing Complete",
            f"Successfully processed {pdf_count} PDF files!\n\n"
            f"Report saved to:\n{output_file}\n\n"
